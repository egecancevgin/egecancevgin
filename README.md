...
### Skills:
[![My Skills](https://skillicons.dev/icons?i=py,cs,cpp,django,flask,fastapi,tensorflow,pytorch,postgres,mongodb,selenium,bash,git,docker,linux)](https://skillicons.dev)
