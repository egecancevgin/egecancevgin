...
### Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=py,linux,redhat,bash,ansible,django,flask,fastapi,git,docker,prometheus,grafana,sklearn,tensorflow)](https://skillicons.dev)
